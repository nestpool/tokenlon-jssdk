...
var transformStompResultToQuoteResult = function (simpleOrder, orderData) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                price = utils_1.toBN(quoteAssetAmountUnit).dividedBy(amount).toNumber();
                return [2 /*return*/, {
                        base: base,
                        quote: quote,
                        side: side,
...
exports.getQuote = function (params) { return __awaiter(_this, void 0, void 0, function () {
    var base, quote, amount, newOrderData, lastOrderData, quoteResult, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 5:
                ...
                return [4 /*yield*/, transformStompResultToQuoteResult(params, lastOrderData)];
            case 6:
                quoteResult = _a.sent();
